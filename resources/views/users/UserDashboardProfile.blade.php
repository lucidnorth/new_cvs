      ...
      <div class="card card-profile">
        ...
        <div class="card-header text-center border-0 pt-0 pt-lg-2 pb-4 pb-lg-3">
          <div class="p-3">
            ...
            @endif
            @if(auth()->user()->employer)
            <a href="" data-bs-toggle="modal" data-bs-target="#EmployeeformModal" class="btn btn-sm btn-info mb-0 d-none d-lg-block mb-3">Edit Account Manager Profile</a>
            @endif
...
<div class="modal fade" id="InstitutionformModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-scrollable">
    ...
    <form id="password-form" class="form" action="{{ route('institution.password.update') }}" method="POST">
        @csrf
      ...
      <div class="modal-body">
        ...
        <div class="tab-content account-tab-content mt-3">
          <div class="tab-pane container active" id="profile">
            <form id="employer-form" class="form" action="{{ route('employer.profile.update') }}" method="POST">
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="text" class="form-control" id="registrationnumber" name="registrationnumber" value="{{ $data->registrationnumber }}" required>
                </div>
                <div class="col-md-6 mb-3">

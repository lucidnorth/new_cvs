                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.certificates.store")}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('student_identification') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="student_identification" id="student_identification" value="{{ old('student_identification', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('qualification_type') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="qualification_type" id="qualification_type" value="{{ old('qualification_type', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('programme') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="programme" id="programme" value="{{ old('programme', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('year_of_entry') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="year_of_entry" id="year_of_entry" value="{{ old('year_of_entry') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('year_of_completion') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="year_of_completion" id="year_of_completion" value="{{ old('year_of_completion') }}" required>

        ...
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                ...
                <button class="btn btn-warning" data-toggle="modal" data-target="#excelImportModal">
                    Import <!-- Change the text to reflect Excel import -->
                </button>
                @include('excelImport.modal', ['model' => 'Institution', 'route' => 'admin.institutions.parseExcelImport'])
            </div>
        </div>
    @endcan
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Institution">
                        <thead>
                            <tr>
                                <th width="10">
...
<script>
    $(function () {
        ...
        let dtOverrideGlobals = {
            ...
            retrieve: true,
            aaSorting: [],
            ajax: "{{ route('admin.institutions.index') }}",
            columns: [
        ...
        let table = $('.datatable-Institution').DataTable(dtOverrideGlobals);

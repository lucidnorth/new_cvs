                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.institutions.store")}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('institutions') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="institutions" id="institutions" value="{{ old('institutions', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="phone" id="phone" value="{{ old('phone', '') }}" step="0.01" required>
                            @if($errors->has('phone'))

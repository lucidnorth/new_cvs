...
class CertificatesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $institutions = Institution::pluck('institutions', 'id'); // Move this line outside of the ajax check
        if ($request->ajax()) {
            ...
            //     return $row->gender ? Certificate::GENDER_SELECT[$row->gender] : '';
            // });
    ...
    public function store(StoreCertificateRequest $request)
    {
         ...
         // Validate the request and include the institution_id
         $request->validate([
